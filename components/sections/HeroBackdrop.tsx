...
// mismo `bg-brand-gradient` de globals.css) con el escudo de Unity como
// elemento gráfico estático, ancorado a la derecha. Sin video ni escena 3D:
// una sola imagen, sin JS de por medio. Un degradado inferior (`.hero-scrim`)
